...
function Footer() {
  return (
    <footer class="dark:bg-gray-900 text-xl text-white bg-neutral-primary mt-12">
        ...
        <div class="px-4 py-6 bg-neutral-secondary-soft md:flex md:items-center md:justify-between">
            <span class="text-sm text-body sm:text-center">© 2026 <a href="https://flowbite.com/">Swiggy</a>. All Rights Reserved.
            </span>
